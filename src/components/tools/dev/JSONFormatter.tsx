        ...
        <div className="rounded-xl border border-border overflow-hidden bg-muted/20">
          {activeTab === "formatted" && (
            <div className="flex flex-col lg:flex-row divide-y lg:divide-y-0 lg:divide-x divide-border">
              {/* Input */}
              <div className="flex flex-col lg:w-1/2 lg:self-stretch">
                ...
                <div className="flex-1 overflow-auto">
                  <textarea
                    ...
                    className="w-full h-full min-h-[500px] font-mono text-sm bg-transparent resize-none p-4 outline-none placeholder:text-muted-foreground/50 leading-relaxed"
                    spellCheck={false}
                    onKeyDown={(e) => {
                      if (e.key === "Tab") {
                        e.preventDefault();
