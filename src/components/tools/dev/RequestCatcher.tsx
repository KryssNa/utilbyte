...
function forwardStatusBadge(status: number | null, error: string | null) {
  if (error) return { label: "Fwd failed", cls: "bg-red-500/15 text-red-500" };
...
export default function RequestCatcher() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes. Click the edit icon next to your Endpoint ID to set a custom name using lowercase letters, numbers, and hyphens.",
    },
    {
  ...
  return (
    <ToolLayout
      ...
      faqs={faqs}
      relatedTools={[
        { title: "Local Proxy", description: "Forward requests to localhost", href: "/dev-tools/local-proxy", icon: Zap, category: "dev" },
        ...
        <div className="rounded-xl border border-border bg-card overflow-hidden">
          ...
          <div className="p-4 space-y-3">
            ...
            <p className="text-[11px] text-muted-foreground">
              ...
              {isForwarding && (
                <span className="text-sky-600 dark:text-sky-400"> Requests are also being forwarded to <strong>{binConfig?.forward_url}</strong>.</span>
              )}
            </p>
          </div>
        </div>
                  ...
                  {detailTab === "body" && (
                    selectedReq.body ? (
                      ...
                      <div className="flex flex-col items-center justify-center h-full text-center py-12">
                        ...
                        <p className="text-[11px] text-muted-foreground/60 mt-1">This request had no body content</p>
                      </div>
                    )
                  )}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {selectedReq.forward_error ? (
                          <span className="text-xs text-red-500 font-medium">{selectedReq.forward_error}</span>
                        ) : (
