...
const Pagination = ({
  ...
  <nav
    ...
    {...props as React.ComponentPropsWithoutRef<"nav">} />
)
...
const PaginationLink = ({
  ...
  size = "icon",
  ...props
}: React.ComponentPropsWithoutRef<"a"> & { isActive: boolean; size?: "icon" | "default" | "sm" | "lg" | "xl" | "icon-sm" | "icon-lg" | null | undefined }) => (
  <a
