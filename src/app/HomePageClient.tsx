      ...
      <section className='relative overflow-hidden'>
        ...
        <div className='container relative mx-auto px-4 py-16 lg:px-8 lg:py-28'>
          ...
          >
            ...
            <motion.p
              variants={itemVariants}
              className='mt-5 text-lg text-muted-foreground sm:text-xl lg:text-2xl max-w-2xl mx-auto leading-relaxed'
            >
            ...
            >
              <Button
                asChild
                size='lg'
                className='h-12 px-8 text-base bg-gradient-to-r from-sky-600 to-teal-600 hover:from-sky-700 hover:to-teal-700 dark:from-sky-500 dark:to-teal-500 dark:hover:from-sky-600 dark:hover:to-teal-600 text-white shadow-lg shadow-sky-500/25'
              >
                <a href='#tools'>
                  Explore All Tools
